...
TEST_CASE("KDTre::quickSelect point value", "[weight=1][part=1]") {
	vector<Point<3>> pts;
	KDTree<3> tree(pts);
	pts.push_back(Point<3>(0, 0, 76));
	pts.push_back(Point<3>(2, 1, 54));
	pts.push_back(Point<3>(6, 1, 2));
	pts.push_back(Point<3>(8, 2, 14));

	Point<3> p = tree.quickSelectP(pts, 1, 0);

	// std::cout << "Vector after quickSelect d0" << std::endl;
	// for (Point<3> p : pts) {
	// 	std::cout << p << " ";
	// }
	// std::cout << std::endl;

	Point<3> p1 = tree.quickSelectP(pts, 1, 1);
	// std::cout << "Vector after quickSelect d1" << std::endl;
	// for (Point<3> p : pts) {
	// 	std::cout << p << " ";
	// }
	// std::cout << std::endl;

	Point<3> p2 = tree.quickSelectP(pts, 1, 2);
	// std::cout << "Vector after quickSelect d2" << std::endl;
	// for (Point<3> p : pts) {
	// 	std::cout << p << " ";
	// }
	// std::cout << std::endl;

	REQUIRE(p == (Point<3>(2, 1, 54)));
	REQUIRE(p1 == (Point<3>(2, 1, 54)));
	REQUIRE(p2 == (Point<3>(8, 2, 14)));
}
...
TEST_CASE("KDTree constructor simple", "[weight=1][part=1]") {
	vector<Point<1>> pts;
	pts.push_back(Point<1>(8));
	pts.push_back(Point<1>(6));
...
TEST_CASE("KDTree copy constructor simple", "[weight=1][part=1]") {
	vector<Point<1>> pts;
	pts.push_back(Point<1>(8));
	pts.push_back(Point<1>(6));
	pts.push_back(Point<1>(0));
...
TEST_CASE("KDTree copy constructor 3D hard", "[weight=1][part=1]") {
...
TEST_CASE("KDTree copy assignment operator simple", "[weight=1][part=1]") {
	vector<Point<1>> pts;
	pts.push_back(Point<1>(8));
	pts.push_back(Point<1>(6));
	pts.push_back(Point<1>(0));
...
TEST_CASE("KDTree copy assignment operator 3D hard", "[weight=1][part=1]") {
	double coords[14][3] = {{0, 0, 100},     // mine
							{0, 100, 100},   // mine
							{0, 50, 50},     // mine
							{0, 0, 50},      // mine
