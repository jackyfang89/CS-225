...
class BinaryTree
{
    ...
    private:
        ...
        Node* minNode(Node* subRoot, Node* min) const;

        Node* maxNode(Node* subRoot, Node* max) const;

        bool isOrderedR(Node* subRoot, Node* min, Node* max) const;
